  ...
  function getJSON() {
    $.ajax({
      ...
      success: function(data) { //요청 성공시 실행될 메서드
        ...
        // 내용
        displayList(dataItems, list_el, dataPerPage, current_page);
        categoryList(dataItems,category_el);

        // 페이징
        pagingList(dataLength, dataPerPage, pageCount, current_page);
